...
function main(servicesPath, additionalServices) {
  ...
  var create = btcnode.scaffold.create;
  var add = btcnode.scaffold.add;
  var start = btcnode.scaffold.start;
  var remove = btcnode.scaffold.remove;
  var callMethod = btcnode.scaffold.callMethod;
  ...
  program
    ...
    .option('-m, --modules <dir>', 'Specify the directory with Btc Node modules')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `btc-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ btc-node add wallet-service');
      console.log('    $ btc-node add explorer-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ btc-node remove wallet-service');
      console.log('    $ btc-node remove explorer-api');
      console.log();
    });
