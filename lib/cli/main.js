...
var btccorenode = require('..');
var utils = require('../utils');

function main(servicesPath, additionalServices) {
  /* jshint maxstatements: 100 */

  var version = btccorenode.version;
  var create = btccorenode.scaffold.create;
  var add = btccorenode.scaffold.add;
  var start = btccorenode.scaffold.start;
  var remove = btccorenode.scaffold.remove;
  var callMethod = btccorenode.scaffold.callMethod;
  var findConfig = btccorenode.scaffold.findConfig;
  var defaultConfig = btccorenode.scaffold.defaultConfig;
  ...
  program
    ...
    .option('-t, --testnet', 'Enable testnet/btc as the network')
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `btccore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ btccore-node add wallet-service');
      console.log('    $ btccore-node add btccore-explorer-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ btccore-node remove wallet-service');
      console.log('    $ btccore-node remove btccore-explorer-api');
      console.log();
    });
