...
/**
 * Will remove a service from btc-node.json
...
/**
 * Will remove the Node.js service and from the btc-node configuration.
 * @param {String} options.cwd - The current working directory
 * @param {String} options.dirname - The btc-node configuration directory
