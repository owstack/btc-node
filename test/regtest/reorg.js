...
var Header = btccore.BlockHeader;
...
var btccore = {
  ...
  datadir: btccoreDataDir,
  exec: path.resolve(__dirname, '../../bin/btccore-node'),
  args: ['start'],
  process: null
};
...
var startFakeNode = function() {
  server = net.createServer(function(socket) {
    ...
    socket.on('end', function() {
      console.log('btccore-node has ended the connection');
    });
...
describe('Reorg', function() {
  // 1. spin up btccore-node and have it connect to our custom tcp socket
        ...
        setTimeout(function() {
          ...
          var request = http.request('http://localhost:53001/api/block/' + reorgBlock.rhash(), function(res) {
            ...
            if (res.statusCode !== 200 && res.statusCode !== 201) {
              ...
              return done('Error from btccore-node webserver: ' + res.statusCode);
            }
