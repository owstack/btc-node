  ...
  it('will return expected configuration', function() {
    var config = JSON.stringify({
      ...
      servicesConfig: {
        bitcoind: {
          spawn: {
            datadir: process.env.HOME + '/.btccore/data',
    ...
    var defaultConfig = proxyquire('../../lib/scaffold/default-config', {
      fs: {
        ...
        writeFileSync: function(path, data) {
          path.should.equal(process.env.HOME + '/.btccore/btccore-node.json');
    ...
    info.path.should.equal(home + '/.btccore');
    ...
    bitcoind.spawn.datadir.should.equal(home + '/.btccore/data');
