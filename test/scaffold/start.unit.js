...
describe('#start', function() {
  describe('#checkConfigVersion2', function() {
    ...
    it('will give true with "datadir" at root', function() {
      ...
      var v2 = checkConfigVersion2({datadir: '/home/user/.btccore/data', services: []});
  ...
  describe('#setupServices', function() {
    ...
    it('will require a local module with "btccoreNode" in package.json', function() {
      function LocalService() {}
      LocalService.dependencies = [];
      LocalService.prototype.start = sinon.stub();
      LocalService.prototype.stop = sinon.stub();
      ...
      var testRequire = function(p) {
        if (p === notfoundPath) {
          ...
          return {
            name: 'local',
            btccoreNode: 'lib/btccoreNode.js'
          };
        } else if (p === 'local/lib/btccoreNode.js') {
          return LocalService;
        }
      };
      var config = {
