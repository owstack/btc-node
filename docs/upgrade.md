...
## From Btccore 3.0.0 to 4.0.0

`btccore-node@2.1.1` to `btccore-node@3.0.0`
...
**Important**: Once changes have been made you'll also need to add the `reindex=1` option **only for the first startup** to regenerate the indexes. Once this is complete you should be able to remove the `btccore-node.db` directory with the old indexes.
